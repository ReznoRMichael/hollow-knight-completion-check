...
const HK_ACHIEVEMENTS = {
    ...
    */
    ...
    falseKnightDreamDefeated: ["Journal: Failed Champion", "Forgotten Crossroads"],
    mageLordDreamDefeated: ["Journal: Soul Tyrant", "City of Tears: Soul Sanctum"],
    infectedKnightDreamDefeated: ["Journal: Lost Kin", "Ancient Basin"],
